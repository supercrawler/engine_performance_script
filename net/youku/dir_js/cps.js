...
(function(){
	...
	var cps_name = "premium_cps",yktk_name = "yktk",cps_val = null,yktk_val = null,uid = 0,log = "";
	...
	var cps_val_arr = cps_val.split("|");
	
	log = [	'"ip":'+cps_val_arr[0],
		'"mid":'+cps_val_arr[1],
		'"cid":'+cps_val_arr[2],
		'"pid":'+cps_val_arr[3],
		'"lpid":'+cps_val_arr[4],
	...
	var url = "http://211.151.50.22/logsys/logstorage/append?project=paysys&log={"+log+"}";
