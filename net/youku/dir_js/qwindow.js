...
Qwindow.prototype = {
	...
	bind: function(){
		...
		if(window.addEventListener){
			window.addEventListener('resize', resetwin, false);
		}else if(window.attachEvent){
			window.attachEvent('onresize', resetwin);
		}
		return this;
	},
	show: function(){
	...
	_getWindowScroll: function(){
		...
		var scrollLeft = document.documentElement ? document.documentElement.scrollLeft + document.body.scrollLeft : document.body.scrollLeft;
